...
INPUT_FILE = "data/transcript.txt"  # place raw transcripts here (one sample per line; ID\tText or just Text)
OUTPUT_FILE = "train/labeled_dataset.jsonl"  # write JSONL compatible with training scripts
